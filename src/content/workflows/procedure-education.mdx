...
socialPost: "This workflow generates procedure-specific patient education materials using prompt templates: pre-procedure preparation guides and post-procedure recovery instructions tailored to the specific case. Patients with clear preparation instructions have fewer complications and better compliance than those given generic institutional handouts."
---
...
- [Creating Inpatient Discharge Education Materials](/workflows/inpatient-discharge-education) — if the procedure was performed during an inpatient stay, this workflow covers the full discharge education package
- [Creating Outpatient Visit Education Materials](/workflows/outpatient-visit-education) — for office-based procedures where patient education is part of the visit wrap-up
- [Claude for Clinical Practice](/tools/claude) — recommended LLM for generating patient education content with nuanced, plain-language output
- [Condition Explainer template](/templates/condition-explainer) — pair with procedure education to explain the underlying condition being treated
- [Prompting 101](/guides/prompting-101) — foundational guide for getting better output from any LLM when generating patient materials
