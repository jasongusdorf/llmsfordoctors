...
socialPost: "This workflow generates procedure-specific patient education materials: pre-procedure preparation guides and post-procedure recovery instructions tailored to the specific case."
---
