...
socialPost: "This workflow walks through a 3-step process for drafting discharge summaries using an LLM. The average discharge summary takes 15-20 minutes; this approach reliably cuts that to under 5 while improving consistency and completeness. Built for hospitalists and anyone managing high-volume discharge documentation."
---
...
- [Discharge Summary Basic template](/templates/discharge-summary-basic) — the core prompt template used in Step 2 of this workflow
- [Creating Inpatient Discharge Education Materials](/workflows/inpatient-discharge-education) — companion workflow for generating patient-facing discharge education alongside the clinical summary
- [Clinical Reasoning workflow](/workflows/clinical-reasoning) — use when the discharge summary requires synthesizing a complex diagnostic workup
- [Hospital Course Summarization trial](/trials/hospital-course-summarization-2025) — evidence on LLM performance for summarizing inpatient courses
- [DESIRE AI Surgical Discharge trial](/trials/desire-ai-surgical-discharge-2025) — trial evaluating AI-assisted discharge documentation in surgical patients
