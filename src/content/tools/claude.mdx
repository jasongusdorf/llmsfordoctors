...
socialPost: "Claude is Anthropic's large language model, rated 5/5 for long-form note generation, nuanced clinical reasoning, and patient communication. One of the few commercial LLMs with a BAA available, making it usable with real patient data in HIPAA-covered"
---
