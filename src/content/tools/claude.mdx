...
socialPost: "Claude is Anthropic's large language model, and it earned a 5/5 in our clinical review for long-form note generation, nuanced clinical reasoning, and patient communication. It is one of the few commercial LLMs with a BAA available, making it usable with real patient data in HIPAA-covered settings."
---
